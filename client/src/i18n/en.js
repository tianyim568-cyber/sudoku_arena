...
export default {
  ...
  puzzleBank: {
    ...
    pdfTitle: 'PDF import',
    pdfDesc: 'Upload a PDF, the server extracts the sudoku puzzles and imports them into the bank.',
    pdfSelectFile: 'Choose a PDF file',
    pdfParseBtn: 'Parse PDF',
    pdfParsing: 'Parsing…',
    pdfCancel: 'Cancel',
    pdfParseFailed: 'PDF parse failed',
    pdfParsedSummary: 'Parsed {n} puzzles',
    pdfFileName: 'File: {name}',
    pdfWarnings: 'Warnings:',
    pdfColId: 'ID',
    pdfColType: 'Type',
    pdfColDifficulty: 'Difficulty',
    pdfColScore: 'Score',
    pdfColEmptyCells: 'Empty cells',
    pdfColPreview: 'Preview',
    pdfTargetRound: 'Target round (optional):',
    pdfTargetRoundGeneric: 'None (generic pool)',
    pdfConfirmBtn: 'Confirm import',
    pdfConfirming: 'Importing…',
    pdfImportedSummary: 'Imported {n} puzzles',
    pdfImportedWithSkipped: 'Imported {n} puzzles ({skipped} duplicates skipped)',
    pdfImportedStripped: 'Note: {n} puzzles had a foreign category id that was cleared.',
    pdfImportFailed: 'Import failed',
