...
export default {
  ...
  puzzleBank: {
    ...
    pdfTitle: 'PDF 导入',
    pdfDesc: '上传 PDF 文件，自动提取数独题目并导入题库',
    pdfSelectFile: '选择 PDF 文件',
    pdfParseBtn: '解析 PDF',
    pdfParsing: '解析中...',
    pdfCancel: '取消',
    pdfParseFailed: 'PDF 解析失败',
    pdfParsedSummary: '成功解析 {n} 道题目',
    pdfFileName: '文件：{name}',
    pdfWarnings: '警告：',
    pdfColId: '编号',
    pdfColType: '类型',
    pdfColDifficulty: '难度',
    pdfColScore: '分数',
    pdfColEmptyCells: '空格数',
    pdfColPreview: '预览',
    pdfTargetRound: '目标轮次（可选）：',
    pdfTargetRoundGeneric: '不指定（通用题库）',
    pdfConfirmBtn: '确认导入',
    pdfConfirming: '导入中...',
    pdfImportedSummary: '成功导入 {n} 道题目',
    pdfImportedWithSkipped: '成功导入 {n} 道题目，跳过 {skipped} 道重复题目',
    pdfImportedStripped: '注意：{n} 道题目的类别不属于本组织，已清除。',
    pdfImportFailed: '导入失败',
