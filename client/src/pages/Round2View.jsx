    ...
    <div className="space-y-4">
      ...
      {rotationWarning && (
        <div className="fixed top-4 left-1/2 -translate-x-1/2 z-50">
          <div className="bg-red-600 text-white px-8 py-4 rounded-xl shadow-2xl shadow-red-600/40 font-bold text-xl flex items-center gap-3">
      ...
      <div className="bg-gray-800 border border-gray-700/50 rounded-lg p-4">
        ...
        <div className="flex items-center gap-2 mt-3">
          {round2State.playerOrder.map((pid, i) => {
            ...
            return (
              <div key={pid} className={`flex items-center gap-1 px-2 py-1 rounded text-xs ${
